...
impl PlayerInfo {
    ...
    pub fn get_local_players(reader: &MemoryReader, base_address: u64, unit_table_offset: u64) -> Vec<PlayerInfo> {
        let mut players = Vec::new();
        if unit_table_offset == 0 { return players; }
